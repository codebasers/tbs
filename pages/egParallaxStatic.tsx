...
const ImgWrapper = ({ children}:OnlyChildProps) => {
	...
	/*	You can add the style directly.
		I have the parallax as a client config so it's easy to have conditions here to include or omit it.
		*/
	...
	return (
		<>
			...
			<div className={styles["text-box"]}>
				...
				<div>
				<p>The principle here is to add the parallax effect on a container div and remove the image from the re-rendering cycle.</p>
				<p>It’s hard to pick if this makes it smoother or I have had too much coffee.</p>
				<p>
